...
<section className="relative w-full mt-20 min-h-screen overflow-hidden">
    ...
    <div className="mx-auto sm:ml-20 w-full max-w-xl">
      <div className="bg-white/30 backdrop-blur-md rounded-xl p-6 sm:p-10 text-left space-y-6 shadow-lg">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-black leading-tight text-gray-900">
          PURE <span className="text-blue-500">WATER</span><br />
  ...
  <div className="absolute bottom-36 right-0 z-20 hidden sm:block w-[40%]">
    <div className="bg-white/90 backdrop-blur-md rounded-tl-3xl py-6 px-6 flex flex-row justify-around items-center gap-6 shadow-xl">
      ...
      <section className="relative w-full min-h-screen px-6 text-gray-800  font-sans">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2 space-y-6 text-center md:text-left">
            ...
            <div className={`flex flex-col sm:flex-row gap-4 mt-6  ${animateButtons ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"} transition-opacity duration-1000`}>
              <button className="bg-blue-600 text-white px-6 py-3 cursor-pointer rounded-full flex items-center gap-2 hover:bg-blue-700 transition">
                <ShoppingBag className="w-5 h-5" />
                Order Now
              </button>
              <button className="border border-blue-400 cursor-pointer text-blue-600 px-6 py-3 rounded-full flex items-center gap-2 hover:bg-blue-50 transition">
